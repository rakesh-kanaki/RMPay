 ...
 */
define(['N/action', 'N/error', 'N/log', 'N/record', 'N/search','./Lib/RMPay_common_lib.js'],
    /**
 * @param{action} action
 * @param{error} error
 * @param{log} log
 ...
 * @param{search} search
 */
    (action, error, log, record, search, rmPayLib) => {
        /**
         ...
         */
         ...
         function getInputData() {
            ...
            const billAmount = search.createColumn({ name: 'amount' });
